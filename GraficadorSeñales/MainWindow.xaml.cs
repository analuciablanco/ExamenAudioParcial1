        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                lblFrecuenciaFundamental.Text =
                    Math.Round(frecuenciaFundamental).ToString() + " Hz";

                if (Math.Round(frecuenciaFundamental) == 400) lblColor.Text = "rojo";
                else if (Math.Round(frecuenciaFundamental) == 800) lblColor.Text = "verde";
                else if (Math.Round(frecuenciaFundamental) == 1200) lblColor.Text = "morado";
                else if (Math.Round(frecuenciaFundamental) == 1600) lblColor.Text = "azul";
                else if (Math.Round(frecuenciaFundamental) == 2000) lblColor.Text = "amarillo";
